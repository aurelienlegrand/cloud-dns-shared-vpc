...
module "project-service-1" {
  source = "github.com/terraform-google-modules/cloud-foundation-fabric//modules/project?ref=v3.3.0"
...
module "project-host" {
  ...
  shared_vpc_config = {
    enabled = true
    service_projects = [
      module.project-service-1.project_id,
      module.project-service-2.project_id
    ]
  }
}
